...
export type SearchQuery = { __typename?: 'Query', search?: { __typename?: 'SearchResult', page: number, totalPages: number, totalResults: number, results: Array<{ __typename: 'Movie', id: string, tmdbId: string, title: string, posterPath: string } | { __typename: 'Tv', id: string, tmdbId: string, name: string, posterPath: string }> } | null };
...
export type MovieQuery = { __typename?: 'Query', movie?: { __typename?: 'Movie', id: string, tmdbId: string, title: string, tagline: string, posterPath: string, backdropPath: string, certification?: string | null, genres: Array<string>, releaseDate: any, rating: number, addedToWatchlist: boolean, reviews: Array<{ __typename?: 'Review', id: string, review: string, createdBy: { __typename?: 'User', id: string, name: string } }>, userReview?: { __typename?: 'Review', id: string, rating: number, review: string } | null } | null };
...
export type TvQuery = { __typename?: 'Query', tv?: { __typename?: 'Tv', id: string, tmdbId: string, name: string, tagline: string, posterPath: string, backdropPath: string, genres: Array<string>, firstAirDate: any, rating: number, addedToWatchlist: boolean, reviews: Array<{ __typename?: 'Review', id: string, review: string, createdBy: { __typename?: 'User', id: string, name: string } }>, userReview?: { __typename?: 'Review', id: string, rating: number, review: string } | null } | null };
