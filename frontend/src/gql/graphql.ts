...
export type SearchQuery = { __typename?: 'Query', search: { __typename?: 'SearchResult', profiles: Array<{ __typename?: 'User', id: string, jellyfinId: string, name: string }>, tmdb: { __typename?: 'TMDBSearchResult', page: number, totalPages: number, totalResults: number, results: Array<{ __typename: 'Movie', id: string, tmdbId: string, title: string, posterPath: string } | { __typename: 'Tv', id: string, tmdbId: string, name: string, posterPath: string }> } } };
...
export type UserFeedQuery = { __typename?: 'Query', userFeed: Array<{ __typename?: 'Recommendation', id: string, message: string, media: { __typename?: 'Movie', id: string, tmdbId: string, title: string, tagline: string, releaseDate: any, posterPath: string, genres: Array<string> } | { __typename?: 'Tv', id: string, tmdbId: string, name: string, tagline: string, firstAirDate: any, posterPath: string, genres: Array<string> }, recommendedBy: { __typename?: 'User', id: string, jellyfinId: string, name: string } }> };
...
export type MovieQuery = { __typename?: 'Query', movie?: { __typename?: 'Movie', id: string, tmdbId: string, title: string, tagline: string, posterPath: string, backdropPath: string, certification?: string | null, genres: Array<string>, releaseDate: any, rating: number, addedToWatchlist: boolean, watched: boolean, reviews: Array<{ __typename?: 'Review', id: string, review: string, createdBy: { __typename?: 'User', id: string, jellyfinId: string, name: string } }>, userReview?: { __typename?: 'Review', id: string, rating: number, review: string } | null } | null };

export type UsersQueryVariables = Exact<{ [key: string]: never; }>;


export type UsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', id: string, jellyfinId: string, name: string }> };
...
export type ReviewMovieMutation = { __typename?: 'Mutation', reviewMovie: { __typename?: 'Review', media: { __typename?: 'Movie', id: string, reviews: Array<{ __typename?: 'Review', review: string, createdBy: { __typename?: 'User', id: string, jellyfinId: string, name: string } }> } | { __typename?: 'Tv' } } };
...
export type TvQuery = { __typename?: 'Query', tv?: { __typename?: 'Tv', id: string, tmdbId: string, name: string, tagline: string, posterPath: string, backdropPath: string, genres: Array<string>, firstAirDate: any, rating: number, addedToWatchlist: boolean, watched: boolean, reviews: Array<{ __typename?: 'Review', id: string, review: string, createdBy: { __typename?: 'User', id: string, jellyfinId: string, name: string } }>, userReview?: { __typename?: 'Review', id: string, rating: number, review: string } | null } | null };
...
export type ReviewTvMutation = { __typename?: 'Mutation', reviewTv: { __typename?: 'Review', media: { __typename?: 'Movie' } | { __typename?: 'Tv', id: string, reviews: Array<{ __typename?: 'Review', review: string, createdBy: { __typename?: 'User', id: string, jellyfinId: string, name: string } }> } } };
