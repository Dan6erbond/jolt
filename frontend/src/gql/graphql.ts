...
export type RecommendMovieMutation = {
  __typename?: "Mutation";
  createRecommendation: { __typename?: "Recommendation"; id: string };
};
...
export type RecommendationsQuery = {
  ...
  me: {
    ...
    recommendations: Array<{
      ...
      id: string;
      message: string;
      media: { __typename: "Movie"; id: string; tmdbId: string };
      recommendedBy: { __typename?: "User"; id: string; name: string };
    }>;
  };
};
...
export type WatchlistQuery = {
  ...
  me: {
    __typename?: "User";
    id: string;
    watchlist: Array<{ __typename: "Movie"; id: string; tmdbId: string }>;
  };
};
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "discoverMovies" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                ...
                { kind: "Field", name: { kind: "Name", value: "posterPath" } },
                {
                  kind: "Field",
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "SignInWithJellyfinInput" },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "signInWithJellyfin" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "input" },
...
export const MyIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "MyId" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<MyIdQuery, MyIdQueryVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "userReview" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<MovieQuery, MovieQueryVariables>;
...
export const ReviewMovieDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "ReviewMovie" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<ReviewMovieMutation, ReviewMovieMutationVariables>;
export const RecommendMovieDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RecommendMovie" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "createRecommendation" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "input" },
                value: {
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      value: { kind: "EnumValue", value: "MOVIE" },
                    },
                    {
                      kind: "ObjectField",
                      name: { kind: "Name", value: "recommendationForUserId" },
                      value: {
                        kind: "Variable",
                        name: { kind: "Name", value: "userId" },
                      },
  ...
  RecommendMovieMutation,
  RecommendMovieMutationVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RateMovie" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<RateMovieMutation, RateMovieMutationVariables>;
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "recommendedBy" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
...
} as unknown as DocumentNode<WatchlistQuery, WatchlistQueryVariables>;
