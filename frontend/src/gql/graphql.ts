...
export type UserByNameQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, profileImageUrl: string, name: string, userFollows: boolean, followers: Array<{ __typename?: 'User', id: string }>, reviews: Array<{ __typename?: 'Review', id: string, rating: number, review: string, media: { __typename?: 'Movie', id: string, tmdbId: string, title: string, posterPath: string, backdropPath: string } | { __typename?: 'Tv', id: string, tmdbId: string, name: string, posterPath: string, backdropPath: string }, createdBy: { __typename?: 'User', id: string, profileImageUrl: string, name: string } }> } | null };
