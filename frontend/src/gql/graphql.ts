...
export type Movie = {
  ...
  id: Scalars['ID'];
  jellyfinUrl?: Maybe<Scalars['String']>;
...
export type SearchQuery = { __typename?: 'Query', search: { __typename?: 'SearchResult', profiles: Array<{ __typename?: 'User', id: string, profileImageUrl: string, name: string }>, tmdb: { __typename?: 'TMDBSearchResult', page: number, totalPages: number, totalResults: number, results: Array<{ __typename: 'Movie', id: string, tmdbId: string, title: string, posterPath: string } | { __typename: 'Tv', id: string, tmdbId: string, name: string, posterPath: string }> } } };
...
export type UserFeedQuery = { __typename?: 'Query', userFeed: Array<{ __typename?: 'Recommendation', id: string, message: string, media: { __typename?: 'Movie', id: string, tmdbId: string, title: string, tagline: string, releaseDate: any, posterPath: string, genres: Array<string> } | { __typename?: 'Tv', id: string, tmdbId: string, name: string, tagline: string, firstAirDate: any, posterPath: string, genres: Array<string> }, recommendedBy: { __typename?: 'User', id: string, profileImageUrl: string, name: string } }> };
...
export type MovieQuery = { __typename?: 'Query', movie?: { __typename?: 'Movie', id: string, tmdbId: string, title: string, tagline: string, posterPath: string, backdropPath: string, certification?: string | null, genres: Array<string>, releaseDate: any, rating: number, addedToWatchlist: boolean, watched: boolean, reviews: Array<{ __typename?: 'Review', id: string, review: string, rating: number, createdBy: { __typename?: 'User', id: string, profileImageUrl: string, name: string } }>, userReview?: { __typename?: 'Review', id: string, rating: number, review: string } | null } | null };

export type UsersQueryVariables = Exact<{ [key: string]: never; }>;


export type UsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', id: string, profileImageUrl: string, name: string }> };
...
export type ReviewMovieMutation = { __typename?: 'Mutation', reviewMovie: { __typename?: 'Review', media: { __typename?: 'Movie', id: string, reviews: Array<{ __typename?: 'Review', review: string, createdBy: { __typename?: 'User', id: string, profileImageUrl: string, name: string } }> } | { __typename?: 'Tv' } } };
...
export type TvQuery = { __typename?: 'Query', tv?: { __typename?: 'Tv', id: string, tmdbId: string, name: string, tagline: string, posterPath: string, backdropPath: string, genres: Array<string>, firstAirDate: any, rating: number, addedToWatchlist: boolean, watched: boolean, reviews: Array<{ __typename?: 'Review', id: string, review: string, rating: number, createdBy: { __typename?: 'User', id: string, profileImageUrl: string, name: string } }>, userReview?: { __typename?: 'Review', id: string, rating: number, review: string } | null } | null };
...
export type ReviewTvMutation = { __typename?: 'Mutation', reviewTv: { __typename?: 'Review', media: { __typename?: 'Movie' } | { __typename?: 'Tv', id: string, reviews: Array<{ __typename?: 'Review', review: string, createdBy: { __typename?: 'User', id: string, profileImageUrl: string, name: string } }> } } };
...
export type UserByNameQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, profileImageUrl: string, name: string, userFollows: boolean, followers: Array<{ __typename?: 'User', id: string }>, reviews: Array<{ __typename?: 'Review', id: string, rating: number, review: string, media: { __typename?: 'Movie', id: string, tmdbId: string, title: string, posterPath: string, backdropPath: string } | { __typename?: 'Tv', id: string, tmdbId: string, name: string, posterPath: string, backdropPath: string }, createdBy: { __typename?: 'User', id: string, profileImageUrl: string, name: string } }>, watched: Array<{ __typename?: 'Movie', id: string, tmdbId: string, title: string, posterPath: string, backdropPath: string } | { __typename?: 'Tv', id: string, tmdbId: string, name: string, posterPath: string, backdropPath: string }> } | null };
...
export type WatchedQueryVariables = Exact<{ [key: string]: never; }>;


export type WatchedQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, watched: Array<{ __typename: 'Movie', id: string, tmdbId: string, jellyfinUrl?: string | null, title: string, overview: string, releaseDate: any, posterPath: string, genres: Array<string>, watched: boolean, addedToWatchlist: boolean, userReview?: { __typename?: 'Review', rating: number, review: string } | null } | { __typename: 'Tv', id: string, tmdbId: string, name: string, overview: string, firstAirDate: any, posterPath: string, genres: Array<string>, watched: boolean, addedToWatchlist: boolean, userReview?: { __typename?: 'Review', rating: number, review: string } | null }> } };

export type WatchlistQueryVariables = Exact<{ [key: string]: never; }>;


export type WatchlistQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, watchlist: Array<{ __typename: 'Movie', id: string, tmdbId: string, jellyfinUrl?: string | null, title: string, overview: string, tagline: string, releaseDate: any, posterPath: string, genres: Array<string>, watched: boolean, addedToWatchlist: boolean } | { __typename: 'Tv', id: string, tmdbId: string, name: string, overview: string, tagline: string, firstAirDate: any, posterPath: string, genres: Array<string>, watched: boolean, addedToWatchlist: boolean }> } };
